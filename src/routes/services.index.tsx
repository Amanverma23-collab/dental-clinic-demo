...
export const Route = createFileRoute("/services/")({
  head: () => ({
    meta: [
      { title: "Our Dental Services — Denta Proof Raipur" },
      { name: "description", content: "Complete dental care in Raipur — cosmetic dentistry, whitening, implants, Invisalign, root canal, pediatric, veneers, emergency care & smile makeovers." },
      { property: "og:title", content: "Dental Services in Raipur — Denta Proof" },
    ],
  }),
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="px-6 pb-16 pt-36 text-center">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-muted-foreground">
          Explore every treatment we offer at Denta Proof, Raipur — from routine cleanings to advanced cosmetic and surgical care.
        </p>
      </section>
