  ...
  return (
    <section className="bg-cream px-6 py-24" id="about">
      <div className="mx-auto grid max-w-6xl items-center gap-12 md:grid-cols-2">
        <img src={clinic} alt="Dr. Dental Sikar clinic interior" loading="lazy" width={1280} height={960} className="h-[480px] w-full rounded-3xl object-cover shadow-sm" />
        <div>
          ...
          <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
            Dr. Dental was built around one idea — visiting the dentist should feel reassuring, not stressful.
